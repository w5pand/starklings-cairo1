...
mod LizInventory {
    ...
    struct Storage {
        ...
        products: LegacyMap<felt252,u32>
    }
    ...
    impl LizInventoryImpl of super::ILizInventory<ContractState> {
        fn add_stock(ref self: ContractState, product:felt252, new_stock:u32) {
            ...
            assert(self.contract_owner.read() == get_caller_address(),'not owner of contract');
            self.products.write(product,self.products.read(product) + new_stock);
        }
        ...
        fn purchase(ref self: ContractState, product:felt252,quantity:u32) {
            ...
            self.products.write(product,self.products.read(product) - quantity);
        }
